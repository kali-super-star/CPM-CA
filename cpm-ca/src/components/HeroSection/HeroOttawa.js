        ...
        <Mozaique {...props}>
            <div  className={MozaiqueStyles.Wrapper}>
                <div className={MozaiqueStyles.InnerContentLeft}>
                    <h1 className={MozaiqueStyles.H1Ottawa}>Psychologues et Thérapeutes à Ottawa</h1>
                    <div className={MozaiqueStyles.SubH1Ottawa}>Découvrez comment nos spécialistes peuvent vous aider</div>
